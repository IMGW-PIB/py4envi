...
from py4envi_openapi_client import rest
from py4envi_openapi_client.configuration import Configuration
from py4envi_openapi_client.exceptions import ApiTypeError, ApiValueError, ApiException
from py4envi_openapi_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.token  # this is an instance of the class Endpoint
        api_instance.token()  # this invokes api_instance.token.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.token.callable or self.callable in this class
