...
def test_json_response_to_df():
    ...
    assert list(df.columns.values) == ['artifacts','footprint','has_zip_artifact','id','product_id','scene_key',
 'timestamp','metadata_content.cloud_cover','metadata_content.format',
 'metadata_content.ingestion_time','metadata_content.polygon',
 'metadata_content.processing_level',
 'metadata_content.relative_orbit_number','metadata_content.schema',
 'metadata_content.sensing_time','metadata_content.spacecraft',
...
def test_json_response_to_gdf():
    ...
    assert list(gdf.columns.values) == ['artifacts','footprint','has_zip_artifact','id','product_id','scene_key',
 'timestamp','metadata_content.cloud_cover','metadata_content.format',
 'metadata_content.ingestion_time','metadata_content.polygon',
 'metadata_content.processing_level',
 'metadata_content.relative_orbit_number','metadata_content.schema',
 'metadata_content.sensing_time','metadata_content.spacecraft',
 'metadata_content.tile','geometry']
